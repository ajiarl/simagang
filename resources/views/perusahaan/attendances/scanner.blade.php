...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <div class="card" style="margin-bottom: 24px; padding: 32px 24px; text-align: center;">
        ...
        @if(session('success'))
            <div style="margin-bottom: 24px; padding: 12px; background: #dcfce7; border-radius: 8px; color: #166534; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
        ...
        @if(session('error'))
            <div style="margin-bottom: 24px; padding: 12px; background: #fee2e2; border-radius: 8px; color: #991b1b; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px;">
