...
<div class="card max-w-2xl">
    <div style="padding: 20px 24px; border-bottom: 1px solid #e2e2e9;">
        <h3 class="text-headline-sm" style="color: #191c20; margin: 0;">Edit Data Dosen Pembimbing</h3>
    </div>
    
    <div style="padding: 24px;">
        <form method="POST" action="{{ route('admin.lecturers.update', $lecturer) }}" style="display: flex; flex-direction: column; gap: 24px;">
            @csrf
            @method('PUT')
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $lecturer->name) }}" required class="form-input" style="width: 100%; padding: 10px 16px; border-radius: 6px; border: 1px solid #c2c6d3;">
                <x-form-error name="name" />
            </div>

            <div style="display: flex; flex-direction: column; gap: 8px;">
                <label for="email" class="text-label-md" style="color: #424751; font-weight: 600;">Email <span style="color: #ba1a1a;">*</span></label>
                <input type="email" id="email" name="email" value="{{ old('email', $lecturer->email) }}" required class="form-input" style="width: 100%; padding: 10px 16px; border-radius: 6px; border: 1px solid #c2c6d3;">
                <x-form-error name="email" />
            </div>

            <div style="display: flex; flex-direction: column; gap: 8px;">
                <label for="phone" class="text-label-md" style="color: #424751; font-weight: 600;">Telepon</label>
                <input type="text" id="phone" name="phone" value="{{ old('phone', $lecturer->phone) }}" class="form-input" style="width: 100%; padding: 10px 16px; border-radius: 6px; border: 1px solid #c2c6d3;">
                <x-form-error name="phone" />
            </div>

            <div style="display: flex; flex-direction: column; gap: 8px;">
                <label for="faculty" class="text-label-md" style="color: #424751; font-weight: 600;">Fakultas</label>
                <input type="text" id="faculty" name="faculty" value="{{ old('faculty', $lecturer->faculty) }}" class="form-input" style="width: 100%; padding: 10px 16px; border-radius: 6px; border: 1px solid #c2c6d3;">
                <x-form-error name="faculty" />
            </div>

            <div style="display: flex; flex-direction: column; gap: 8px;">
                <label for="department" class="text-label-md" style="color: #424751; font-weight: 600;">Departemen / Program Studi</label>
                <input type="text" id="department" name="department" value="{{ old('department', $lecturer->department) }}" class="form-input" style="width: 100%; padding: 10px 16px; border-radius: 6px; border: 1px solid #c2c6d3;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                <label for="password_confirmation" class="text-label-md" style="color: #424751; font-weight: 600;">Konfirmasi Password Baru</label>
                <div style="position: relative;">
